  ...
  () => {
    ...
    const getTRDeposit = function () {
      axios({
        ...
        }:8000/products/deposit-products/top_rate/`,
      }).then((res) => {
    ...
    const getTRSaving = function () {
      axios({
        ...
        url: `http://${
          import.meta.env.VITE_ENV_BACK_END_URL
        }:8000/products/saving-products/top_rate/`,
      }).then((res) => {
    ...
    const getProductListD = function () {
      axios({
        ...
        url: `http://${
          import.meta.env.VITE_ENV_BACK_END_URL
        }:8000/products/deposit-products/`,
      }).then((res) => {
    ...
    const getSubPrdtDep = function () {
      axios({
        ...
        url: `http://${
          import.meta.env.VITE_ENV_BACK_END_URL
        }:8000/profilepage/subscribed-deposit/`,
        headers: {
    ...
    const getSubPrdtSav = function () {
      axios({
        ...
        url: `http://${
          import.meta.env.VITE_ENV_BACK_END_URL
        }:8000/profilepage/subscribed-saving/`,
        headers: {
          Authorization: `Token ${token.value}`,
        },
      }).then((res) => {
    ...
    const getBoardList = function () {
      axios({
        method: "get",
        url: `http://${import.meta.env.VITE_ENV_BACK_END_URL}:8000/articles/`,
      }).then((res) => {
    ...
    const getStockNews = function () {
      axios({
        method: "get",
        url: `http://${import.meta.env.VITE_ENV_BACK_END_URL}:8000/news/stock/`,
      }).then((res) => {
    ...
    const getCoinNews = function () {
      axios({
        method: "get",
        url: `http://${import.meta.env.VITE_ENV_BACK_END_URL}:8000/news/coin/`,
      }).then((res) => {
    ...
    const getRecommendProduct = function () {
      axios({
        ...
        url: `http://${
          import.meta.env.VITE_ENV_BACK_END_URL
        }:8000/profilepage/recommend-products/`,
        headers: {
          Authorization: `Token ${token.value}`,
        },
      }).then((res) => {
