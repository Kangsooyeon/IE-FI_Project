<template>
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <p class="navbar-brand logo" @click="goHome" href="#">
          <img src="@/assets/logo/IE-FI.png" width="120" alt="Logo" />
        </p>
        <div
          v-if="!store.isLogin"
        ...
        >
          <p
            @click="goLogin"
            class="navbar-brand btn custom-btn login-btn mr-3"
          >
            로그인
          </p>
          <p
            @click="goRegister"
            class="navbar-brand btn custom-btn register-btn"
          >
            회원가입
          </p>
        </div>
        ...
        >
          <div class="offcanvas-header d-lg-none">
            <p @click="goHome" class="navbar-brand logo" href="#">
              <img
                src="https://edu.ssafy.com/asset/images/header-logo.jpg"
                alt="Logo"
                height="40"
              />
            </p>
          ...
          <div class="offcanvas-body d-lg-none">
            <div v-if="!store.isLogin">
              <p
                @click="goLogin"
                class="navbar-brand btn custom-btn login-btn mr-3 mb-1"
                href="#"
              >
                로그인
              </p>
              <p
                @click="goRegister"
                class="navbar-brand btn custom-btn register-btn mb-3"
                href="#"
              >
                회원가입
              </p>
            ...
            <div v-else>
              <p
                @click="goPofile"
                class="navbar-brand profile mr-3 mb-1"
                href="#"
              >
                프로필
              </p>
