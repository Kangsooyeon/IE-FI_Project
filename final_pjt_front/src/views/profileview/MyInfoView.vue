      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <input
              v-else
              v-model="editedUserInfo.id_name"
              type="text"
              class="form-control"
              disabled
            />
        ...
        <tr>
          ...
          <td>
            ...
            <input
              v-else
              v-model="editedUserInfo.nickname"
              type="text"
              class="form-control"
            />
            <span v-if="errors.nickname" class="text-danger">{{
              errors.nickname
            }}</span>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <input
              v-else
              v-model="editedUserInfo.birth"
              type="text"
              class="form-control"
            />
            <span v-if="errors.birth" class="text-danger">{{
              errors.birth
            }}</span>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <select
              v-else
              v-model="editedUserInfo.main_bank"
              class="form-select"
            >
            ...
            <span v-if="errors.main_bank" class="text-danger">{{
              errors.main_bank
            }}</span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <input
              v-else
              v-model="editedUserInfo.asset"
              type="text"
              class="form-control"
            />
            <span v-if="errors.asset" class="text-danger">{{
              errors.asset
            }}</span>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <input
              v-else
              v-model="editedUserInfo.desired_asset"
              type="text"
              class="form-control"
            />
            <span v-if="errors.desired_asset" class="text-danger">{{
              errors.desired_asset
            }}</span>
          </td>
        </tr>
      </tbody>
...
const validate = () => {
  ...
  if (
    editedUserInfo.value.salary &&
    (isNaN(editedUserInfo.value.salary) || editedUserInfo.value.salary < 0)
  ) {
  ...
  if (
    editedUserInfo.value.asset &&
    (isNaN(editedUserInfo.value.asset) || editedUserInfo.value.asset < 0)
  ) {
  ...
  if (
    editedUserInfo.value.desired_asset &&
    (isNaN(editedUserInfo.value.desired_asset) ||
      editedUserInfo.value.desired_asset < 0)
  ) {
