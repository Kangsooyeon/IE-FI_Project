      ...
      <div class="card-body">
        ...
        <form @submit.prevent="register">
          <div
            :class="[
              'form-group',
              { 'has-error': !valid.id_name && submitted },
            ]"
          >
          ...
          <div
            :class="[
              'form-group',
              { 'has-error': !valid.password && submitted },
            ]"
          >
          ...
          <div
            :class="[
              'form-group',
              { 'has-error': !valid.password2 && submitted },
            ]"
          >
          ...
          <div
            :class="[
              'form-group',
              { 'has-error': !valid.nickname && submitted },
            ]"
          >
          ...
          <div
            :class="['form-group', { 'has-error': !valid.email && submitted }]"
          >
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="main_bank" v-model="main_bank">
              ...
              <option v-for="bank1 in store.banks" :key="bank1">
                {{ bank1 }}
              </option>
            </select>
          </div>
