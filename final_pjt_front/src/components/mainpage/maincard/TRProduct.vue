<template>
    <div class="TR-container">
        ...
        <div v-if="store.topRateDeposit!=null && !toogleOption" class="ms-3 TR-list">
            <p v-for="(productD,idx) in store.topRateDeposit" :key="productD.deposit_product.fin_prdt_nm" class="TR-item under-line">
        ...
        <div v-if="store.topRateSaving!=null && toogleOption" class="ms-3 TR-list">
            <p v-for="(productS,idx) in store.topRateSaving" :key="productS.saving_product.fin_prdt_nm" class="TR-item under-line">
