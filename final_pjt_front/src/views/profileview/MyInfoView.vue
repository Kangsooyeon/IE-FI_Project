    ...
    <table class="table  ms-auto me-auto mt-4">
      <tbody>
        ...
        <tr>
          <th scope="row">연봉</th>
          <td>
            <span v-if="!isEditing">{{ store.userInfo.salary ? store.userInfo.salary.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원" :""}}</span>
        ...
        <tr>
          <th scope="row">자산</th>
          <td>
            <span v-if="!isEditing">{{ store.userInfo.asset ? store.userInfo.asset.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원":""}}</span>
        ...
        <tr>
          ...
          <td>
            <span v-if="!isEditing">{{ store.userInfo.desired_asset ? store.userInfo.desired_asset.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원" :"" }}</span>
